...
class GamesAndCategoriesSeeder extends Seeder
{
    public function run()
    {
        ...
        $matchGame = Game::create([
            'title'       => 'Match the Word to the Image',
            'description' => 'This fun and visual game lets learners match words to the correct image, helping reinforce vocabulary through recognition and repetition.',
            'file'        => 'js/matchingGame.js',
            'thumbnail'   => 'images/matchgame.png'
        ]);
    }
}